...
在我们设定的条件下，排球每次弹起达到相同高度，故需每次与鼓面碰撞后都有相同的初速度，且与碰撞前速度等大反向，撞后仅受重力作用，故有：
$$v_2^{'}=-v_2$$ $$\frac{1}{2}g(\frac{T}{2})^2=0.4m$$
\begin{equation*}
\left\{
\begin{array}{lr}
v_2^{'}=-v_2 \\
...
$$e=\frac{|v_2^{'}-v_1^{'}|}{|v_2-v_1|} \label{eq:newton}$$
...
\subsection{空气阻力}
空气阻力是物体下落过程中影响速度的重要因素。查阅资料得物体在介质运动所受的空气阻力为$$f=\frac{1}{2}c\rho Sv^n$$
